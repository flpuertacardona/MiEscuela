...
namespace MiEscuela.Web.Controllers
{
    public class AlumnosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Documento,TipoDocumento,Genero,CursoId,Id,Nombre")] Alumno alumno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Documento,TipoDocumento,Genero,CursoId,Id,Nombre")] Alumno alumno)
        {
            if (id != alumno.Id)
            {
                return NotFound();
